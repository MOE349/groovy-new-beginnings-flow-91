            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-sm font-medium">
                      {assets.operational || 85}%
                    </span>
                    <Progress
                      value={assets.operational || 85}
                      className="w-20"
                    />
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-sm font-medium">
                      {assets.maintenance || 10}%
                    </span>
                    <Progress
                      value={assets.maintenance || 10}
                      className="w-20"
                    />
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-sm font-medium">
                      {assets.outOfService || 5}%
                    </span>
                    <Progress
                      value={assets.outOfService || 5}
                      className="w-20"
                    />
                  </div>
                </div>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-3">
                {quickActions.map((action, index) => (
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-full ${action.color} flex items-center justify-center mb-2`}
                    >
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm">
                    {performance.driverSatisfaction || 88}%
                  </span>
                </div>
