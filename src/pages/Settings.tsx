...
const Settings = () => {
  ...
  const handleSiteSubmit = async (data: Record<string, any>) => {
    try {
      setLoading(true);
      if (editingItem) {
        await apiCall(`/company/site/${editingItem.id}`, {
          method: "PUT",
          body: data,
        });
        toast({
      ...
      toast({
        ...
        description:
          error.message ||
          `Failed to ${editingItem ? "update" : "create"} site`,
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleLocationSubmit = async (data: Record<string, any>) => {
    try {
      setLoading(true);
      if (editingItem) {
        await apiCall(`/company/location/${editingItem.id}`, {
          method: "PUT",
          body: data,
        });
        toast({
      ...
      toast({
        ...
        description:
          error.message ||
          `Failed to ${editingItem ? "update" : "create"} location`,
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleEquipmentCategorySubmit = async (data: Record<string, any>) => {
    try {
      setLoading(true);
      if (editingItem) {
        await apiCall(`/assets/equipment_category/${editingItem.id}`, {
          method: "PUT",
          body: data,
        });
        toast({
      ...
      await queryClient.invalidateQueries({
        queryKey: ["/assets/equipment_category"],
      });
      setDialogOpen(null);
      setEditingItem(null);
    } catch (error: any) {
      toast({
        ...
        description:
          error.message ||
          `Failed to ${editingItem ? "update" : "create"} equipment category`,
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleAttachmentCategorySubmit = async (data: Record<string, any>) => {
    try {
      setLoading(true);
      if (editingItem) {
        await apiCall(`/assets/attachment_category/${editingItem.id}`, {
          method: "PUT",
          body: data,
        });
        toast({
      ...
      await queryClient.invalidateQueries({
        queryKey: ["/assets/attachment_category"],
      });
      setDialogOpen(null);
      setEditingItem(null);
    } catch (error: any) {
      toast({
        ...
        description:
          error.message ||
          `Failed to ${editingItem ? "update" : "create"} attachment category`,
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleWorkOrderStatusSubmit = async (data: Record<string, any>) => {
    try {
      setLoading(true);
      if (editingItem) {
        await apiCall(`/work-orders/status/${editingItem.id}`, {
          method: "PUT",
          body: data,
        });
        toast({
      ...
      toast({
        ...
        description:
          error.message ||
          `Failed to ${editingItem ? "update" : "create"} work order status`,
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleWeightClassSubmit = async (data: Record<string, any>) => {
    try {
      setLoading(true);
      if (editingItem) {
        await apiCall(`/assets/equipment_weight_class/${editingItem.id}`, {
          method: "PUT",
          body: data,
        });
        toast({
        ...
        await apiCall("/assets/equipment_weight_class", {
          method: "POST",
          body: data,
        });
        toast({
      ...
      await queryClient.invalidateQueries({
        queryKey: ["/assets/equipment_weight_class"],
      });
      setDialogOpen(null);
      setEditingItem(null);
    } catch (error: any) {
      toast({
        ...
        description:
          error.message ||
          `Failed to ${editingItem ? "update" : "create"} weight class`,
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleProjectSubmit = async (data: Record<string, any>) => {
    try {
      setLoading(true);
      if (editingItem) {
        await apiCall(`/projects/projects/${editingItem.id}`, {
          method: "PUT",
          body: data,
        });
        toast({
  ...
  const handleAccountCodeSubmit = async (data: Record<string, any>) => {
    try {
      setLoading(true);
      if (editingItem) {
        await apiCall(`/projects/account-codes/${editingItem.id}`, {
          method: "PUT",
          body: data,
        });
        toast({
        ...
        await apiCall("/projects/account-codes", {
          method: "POST",
          body: data,
        });
        toast({
      ...
      await queryClient.invalidateQueries({
        queryKey: ["/projects/account-codes"],
      });
      setDialogOpen(null);
      setEditingItem(null);
    } catch (error: any) {
      toast({
        ...
        description:
          error.message ||
          `Failed to ${editingItem ? "update" : "create"} account code`,
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleJobCodeSubmit = async (data: Record<string, any>) => {
    try {
      setLoading(true);
      if (editingItem) {
        await apiCall(`/projects/job-codes/${editingItem.id}`, {
          method: "PUT",
          body: data,
        });
        toast({
      ...
      toast({
        ...
        description:
          error.message ||
          `Failed to ${editingItem ? "update" : "create"} job code`,
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleAssetStatusSubmit = async (data: Record<string, any>) => {
    try {
      setLoading(true);
      if (editingItem) {
        await apiCall(`/projects/asset-statuses/${editingItem.id}`, {
          method: "PUT",
          body: data,
        });
        toast({
        ...
        await apiCall("/projects/asset-statuses", {
          method: "POST",
          body: data,
        });
        toast({
      ...
      await queryClient.invalidateQueries({
        queryKey: ["/projects/asset-statuses"],
      });
      setDialogOpen(null);
      setEditingItem(null);
    } catch (error: any) {
      toast({
        ...
        description:
          error.message ||
          `Failed to ${editingItem ? "update" : "create"} asset status`,
        variant: "destructive",
      });
    } finally {
      setLoading(false);
      ...
      <div className="space-y-6 min-w-[1440px]">
        <Tabs defaultValue="sites" className="w-full mt-8">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="workorder-settings">
              WorkOrder Settings
            </TabsTrigger>
          </TabsList>
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="space-y-4">
                <ApiTable
                  ...
                  onCreateNew={() => {
                    setEditingItem(null);
                    setDialogOpen("equipmentCategory");
                  }}
                ...
                <ApiTable
                  ...
                  onCreateNew={() => {
                    setEditingItem(null);
                    setDialogOpen("attachmentCategory");
                  }}
                  onRowClick={(row) =>
                    handleRowClick(row, "attachmentCategory")
                  }
          ...
          <TabsContent value="categories" className="space-y-4">
            <div className="text-center text-muted-foreground py-8">
              Equipment and Attachment Categories have been moved to the Sites
              tab.
            </div>
          </TabsContent>
        ...
        >
          <DialogContent className="max-w-md max-h-[80vh] overflow-hidden">
            <DialogHeader>
              <DialogTitle>
                {editingItem ? "Edit Site" : "Create New Site"}
              </DialogTitle>
            </DialogHeader>
            <ApiForm
              ...
              initialData={
                editingItem
                  ? prepareInitialData(editingItem, siteFormFields)
                  : {}
              }
        ...
        >
          <DialogContent className="max-w-md max-h-[80vh] overflow-hidden">
            ...
            <ApiForm
              ...
              initialData={
                editingItem
                  ? prepareInitialData(editingItem, locationFormFields)
                  : {}
              }
              customLayout={customLayout(
                editingItem ? "Edit Location" : "Create New Location",
        ...
        <Dialog
          open={dialogOpen === "equipmentCategory"}
          onOpenChange={(open) => {
            if (!open) {
              setDialogOpen(null);
              setEditingItem(null);
        ...
        >
          <DialogContent className="max-w-md max-h-[80vh] overflow-hidden">
            ...
            <ApiForm
              ...
              initialData={
                editingItem
                  ? prepareInitialData(editingItem, equipmentCategoryFormFields)
                  : {}
              }
              customLayout={customLayout(
                editingItem
        ...
        <Dialog
          open={dialogOpen === "attachmentCategory"}
          onOpenChange={(open) => {
            if (!open) {
              setDialogOpen(null);
              setEditingItem(null);
            ...
            <ApiForm
              ...
              customLayout={customLayout(
                editingItem
                  ? "Edit Attachment Category"
                  : "Create New Attachment Category",
                handleAttachmentCategorySubmit,
                attachmentCategoryFormFields
              )}
            />
          </DialogContent>
        ...
        <Dialog
          open={dialogOpen === "workOrderStatus"}
          onOpenChange={(open) => {
            if (!open) {
              setDialogOpen(null);
              setEditingItem(null);
        ...
        >
          <DialogContent className="max-w-md max-h-[80vh] overflow-hidden">
            <DialogHeader>
              <DialogTitle>
                {editingItem ? "Edit WorkOrder Status" : "Add WorkOrder Status"}
              </DialogTitle>
            </DialogHeader>
            <ApiForm
              ...
              initialData={
                editingItem
                  ? prepareInitialData(editingItem, workOrderStatusFormFields)
                  : {}
              }
              customLayout={customLayout(
                editingItem ? "Edit WorkOrder Status" : "Add WorkOrder Status",
                handleWorkOrderStatusSubmit,
                workOrderStatusFormFields
              )}
            />
          </DialogContent>
        ...
        >
          <DialogContent className="max-w-md max-h-[80vh] overflow-hidden">
            <DialogHeader>
              <DialogTitle>
                {editingItem ? "Edit Weight Class" : "Create New Weight Class"}
              </DialogTitle>
            </DialogHeader>
            <ApiForm
              ...
              initialData={
                editingItem
                  ? prepareInitialData(editingItem, weightClassFormFields)
                  : {}
              }
              customLayout={customLayout(
                editingItem ? "Edit Weight Class" : "Create New Weight Class",
                handleWeightClassSubmit,
                weightClassFormFields
              )}
            />
          </DialogContent>
        ...
        >
          <DialogContent className="max-w-md max-h-[80vh] overflow-hidden">
            ...
            <ApiForm
              ...
              initialData={
                editingItem
                  ? prepareInitialData(editingItem, projectFormFields)
                  : {}
              }
              customLayout={customLayout(
                editingItem ? "Edit Project" : "Create New Project",
        ...
        >
          <DialogContent className="max-w-md max-h-[80vh] overflow-hidden">
            <DialogHeader>
              <DialogTitle>
                {editingItem ? "Edit Account Code" : "Create New Account Code"}
              </DialogTitle>
            </DialogHeader>
            <ApiForm
              ...
              initialData={
                editingItem
                  ? prepareInitialData(editingItem, accountCodeFormFields)
                  : {}
              }
              customLayout={customLayout(
                editingItem ? "Edit Account Code" : "Create New Account Code",
        ...
        >
          <DialogContent className="max-w-md max-h-[80vh] overflow-hidden">
            <DialogHeader>
              <DialogTitle>
                {editingItem ? "Edit Job Code" : "Create New Job Code"}
              </DialogTitle>
            </DialogHeader>
            <ApiForm
              ...
              initialData={
                editingItem
                  ? prepareInitialData(editingItem, jobCodeFormFields)
                  : {}
              }
              customLayout={customLayout(
                editingItem ? "Edit Job Code" : "Create New Job Code",
        ...
        >
          <DialogContent className="max-w-md max-h-[80vh] overflow-hidden">
            ...
            <ApiForm
              ...
              initialData={
                editingItem
                  ? prepareInitialData(editingItem, assetStatusFormFields)
                  : {}
              }
              customLayout={customLayout(
                editingItem ? "Edit Asset Status" : "Create New Asset Status",
