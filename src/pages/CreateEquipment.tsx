    ...
    <div className="h-full overflow-x-auto min-w-0">
      <div className="space-y-6 min-w-[1440px]">
        <CreateEntityFormPage
          ...
          createEndpoint="/assets/equipments"
          getEditRoute={(id) => `/asset/edit/${id}`}
          customFormLayout={(props) => (
            <FormLayout {...props} config={equipmentFormConfig} />
          )}
          onSuccessToast={{ description: "Equipment created successfully!" }}
        />
            ...
            <TabsContent value="metering-events" className="mt-1">
              <div className="bg-card rounded-sm shadow-xs p-4 h-full min-h-[500px] flex items-center justify-center">
                <div className="text-center text-muted-foreground">
                  ...
                  <p className="text-caption text-muted-foreground">
                    Create the equipment first, then add meter readings in the
                    edit view.
                  </p>
                </div>
              </div>
