      ...
      <div>
        <Tabs defaultValue="parts-bom" className="h-full">
          ...
          <div className="h-10 overflow-x-auto">
            <TabsList className="grid w-full grid-cols-7 h-10 bg-primary border border-border rounded-md p-0">
              <TabsTrigger 
                value="parts-bom" 
                className="px-4 py-1 text-caption font-normal text-secondary data-[state=active]:text-secondary data-[state=active]:border-b-2 data-[state=active]:border-secondary data-[state=active]:bg-transparent hover:text-secondary/80 rounded-none"
              >
                Parts/BOM
              </TabsTrigger>
              <TabsTrigger 
