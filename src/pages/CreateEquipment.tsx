          ...
          <div className="flex gap-8">
            ...
            <div className="flex-1">
              <div className="grid grid-cols-3 gap-x-8 gap-y-2">
                {/* First sub-column */}
                <div className="p-4 border-l-2 border-r-2 border-secondary/40 rounded-xl shadow-lg shadow-secondary/10 space-y-2 relative before:absolute before:left-0 before:right-0 before:top-0 before:h-2 before:bg-gradient-to-b before:from-secondary/20 before:to-transparent before:rounded-t-xl after:absolute after:left-0 after:right-0 after:bottom-0 after:h-2 after:bg-gradient-to-t after:from-secondary/20 after:to-transparent after:rounded-b-xl">
