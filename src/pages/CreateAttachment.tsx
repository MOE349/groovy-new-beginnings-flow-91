          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <div className="lg:col-span-4 space-y-3 flex flex-col">
              ...
              <div className="space-y-1">
                <label className="block text-caption font-normal text-right w-20 text-foreground">Location</label>
                {renderField({ 
                  name: "location", 
                  type: "dropdown", 
                  required: true, 
          ...
          <TabsContent value="metering-events" className="mt-4">
            <div className="bg-card rounded-sm shadow-xs p-4 space-y-4 flex items-center justify-center">
              <div className="text-center text-muted-foreground">
                <h3 className="text-h3 font-medium text-foreground mb-2">Metering/Events</h3>
                <p className="text-caption">Create the attachment first, then add meter readings in the edit view.</p>
              </div>
            </div>
          </TabsContent>
