...
const CreateAsset = () => {
  ...
  const [assetType, setAssetType] = useState<"equipment" | "attachment" | null>(
    null
  );
    ...
    return (
      <div className="px-6 space-y-4 min-w-0">
        <div className="h-14 flex items-center justify-between px-4 py-2 bg-card border-b border-border">
          <div>
            <h1 className="text-h3 font-medium text-primary">
              Create New Asset
            </h1>
        ...
        <div className="max-w-xl">
          <div className="bg-card rounded-md shadow-sm px-2 py-1">
            <h3 className="text-h3 font-medium mb-4 text-primary">
              Select Asset Type
            </h3>
      ...
      <div className="bg-card rounded-md shadow-sm px-2 py-1 mt-4">
        <form onSubmit={handleSubmit} className="h-full">
          <div className="flex items-center gap-4 mb-4 py-1 -mx-2 bg-muted-foreground/20 border border-border rounded-md">
            <h3 className="text-h3 font-medium text-primary ml-6">
              {assetTypeName} Information
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 -mt-2">
            ...
            <div className="lg:col-span-4 space-y-3 flex flex-col">
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleFieldChange("is_online", checked)
                  }
                />
              ...
              <div className="space-y-1">
                <label className="block text-caption font-normal text-right w-24 text-foreground">
                  Location
                </label>
                {renderField({
                  name: "location",
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-3 gap-y-2">
                ...
                <div className="p-6 space-y-2 relative before:absolute before:left-0 before:top-4 before:bottom-4 before:w-0.5 before:bg-gradient-to-b before:from-primary/60 before:via-primary/80 before:to-primary/60 before:rounded-full before:shadow-md after:absolute after:right-0 after:top-4 after:bottom-4 after:w-0.5 after:bg-gradient-to-b after:from-primary/60 before:via-primary/80 after:to-primary/60 after:rounded-full after:shadow-md shadow-xl shadow-primary/5 bg-gradient-to-br from-background via-card to-background border border-primary/10 rounded-3xl">
                  <div className="flex items-start gap-2 h-10">
                    <label className="block text-caption font-normal text-right w-24 text-foreground shrink-0 pt-2.5">
                      Code
                    </label>
                  ...
                  <div className="flex items-start space-x-2">
                    <label className="block text-caption font-normal text-right w-20 text-foreground shrink-0 pt-1">
                      Description
                    </label>
                    <div className="flex-grow">
                      {renderField({
                  ...
                  {assetType === "attachment" && (
                    <div className="flex items-start gap-2 h-10">
                      <label className="block text-caption font-normal text-right w-24 text-foreground shrink-0 pt-0">
                        Equipment
                      </label>
                      <div className="flex-grow">
                        {renderField({
                  ...
                  <div className="flex items-start gap-2 h-10">
                    ...
                    <div className="flex-grow">
                      {renderField({
                        ...
                        endpoint:
                          assetType === "equipment"
                            ? "/assets/equipment_category"
                            : "/assets/attachment_category",
                        queryKey:
                          assetType === "equipment"
                            ? ["equipment_category"]
                            : ["attachment_category"],
