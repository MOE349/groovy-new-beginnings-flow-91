                  ...
                  <div className="flex w-1/2 h-full flex-shrink-0">
                    ...
                    <div className="w-full md:w-1/2 pl-3">
                      <div className="p-10 space-y-4 h-[474px] relative before:absolute before:left-0 before:top-4 before:bottom-4 before:w-0.5 before:bg-gradient-to-b before:from-primary/60 before:via-primary/80 before:to-primary/60 before:rounded-full before:shadow-md after:absolute after:right-0 after:top-4 after:bottom-4 after:w-0.5 after:bg-gradient-to-b after:from-primary/60 after:via-primary/80 after:to-primary/60 after:rounded-full after:shadow-md shadow-xl shadow-primary/5 bg-gradient-to-br from-background via-card to-background border border-primary/10 rounded-3xl">
                        ...
                        <div className="pt-12 space-y-4 overflow-auto max-h-[400px]">
                          {/* PM Work Orders Table */}
                          <div className="space-y-3">
                            <h6 className="text-sm font-semibold text-foreground">PM Work Orders</h6>
                            <div className="border border-border rounded-md overflow-hidden">
                              <table className="w-full text-sm">
                                <thead className="bg-muted">
                                  <tr>
                                    <th className="px-4 py-3 text-left font-semibold text-base">Work Order #</th>
                                    <th className="px-4 py-3 text-left font-semibold text-base">Status</th>
                                    <th className="px-4 py-3 text-left font-semibold text-base">Maintenance Type</th>
                                    <th className="px-4 py-3 text-left font-semibold text-base">Date Opened</th>
                                    <th className="px-4 py-3 text-left font-semibold text-base">Date Closed</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  <tr className="border-t border-border">
                                    <td className="px-4 py-3 text-base">WO-001</td>
                                    <td className="px-4 py-3">
                                      <span className="px-2 py-1 text-sm bg-green-100 text-green-800 rounded">Complete</span>
                                    </td>
                                    <td className="px-4 py-3 text-base">Preventive</td>
                                    <td className="px-4 py-3 text-base">01/15/2024</td>
                                    <td className="px-4 py-3 text-base">01/16/2024</td>
                                  </tr>
                                  <tr className="border-t border-border">
                                    <td className="px-4 py-3 text-base">WO-002</td>
                                    <td className="px-4 py-3">
                                      <span className="px-2 py-1 text-sm bg-yellow-100 text-yellow-800 rounded">In Progress</span>
                                    </td>
                                    <td className="px-4 py-3 text-base">Corrective</td>
                                    <td className="px-4 py-3 text-base">01/20/2024</td>
                          ...
                          {/* Activity Log Table */}
                          <div className="space-y-3">
                            <h6 className="text-sm font-semibold text-foreground">Activity Log</h6>
                            <div className="border border-border rounded-md overflow-hidden">
                              <table className="w-full text-sm">
                                <thead className="bg-muted">
                                  <tr>
                                    <th className="px-4 py-3 text-left font-semibold text-base">Date</th>
                                    <th className="px-4 py-3 text-left font-semibold text-base">Log Type</th>
                                    <th className="px-4 py-3 text-left font-semibold text-base">Notes</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  <tr className="border-t border-border">
                                    <td className="px-4 py-3 text-base">01/22/2024</td>
                                    <td className="px-4 py-3">
                                      <span className="px-2 py-1 text-sm bg-blue-100 text-blue-800 rounded">Inspection</span>
                                    </td>
                                    <td className="px-4 py-3 text-base">Routine inspection completed</td>
                                  </tr>
                                  <tr className="border-t border-border">
                                    <td className="px-4 py-3 text-base">01/20/2024</td>
                                    <td className="px-4 py-3">
                                      <span className="px-2 py-1 text-sm bg-orange-100 text-orange-800 rounded">Maintenance</span>
                                    </td>
                                    <td className="px-4 py-3 text-base">Oil change performed</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
