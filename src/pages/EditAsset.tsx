...
const EditAsset = () => {
  ...
  return <div className="overflow-x-auto min-w-0">
      <div className="space-y-4 min-w-[1440px]">
        ...
        <div>
        <Tabs defaultValue="metering-events" onValueChange={setActiveTab}>
          ...
          <TabsContent value="scheduled-maintenance" className="mt-1">
            <div className="bg-card rounded-sm shadow-xs p-2 min-h-[500px] overflow-hidden">
              {currentView === 0 && <div className="flex gap-4 relative animate-fade-in">
              ...
              {currentView === 1 && <div className="relative animate-fade-in">
