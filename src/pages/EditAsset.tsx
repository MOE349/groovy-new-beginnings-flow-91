          ...
          >
                      ...
                      <ApiForm
                        ...
                        onSubmit={async (data) => {
                          ...
                          try {
                            ...
                            queryClient.invalidateQueries({
                              queryKey: [
                                `/meter-readings/meter_reading?asset=${id}`,
                              ],
                            });
                            queryClient.invalidateQueries({
                              queryKey: ["meter_readings", id],
                        ...
                        onSubmit={async (data) => {
                          ...
                          try {
                            ...
                            toast({
                              title: "Error",
                              description:
                                error.message || "Failed to add code",
                              variant: "destructive",
                            });
                          }
                        }}
            ...
            >
              <div className="tab-content-maintenance">
                {currentView === 0 && (
                  <div className="grid grid-cols-4 gap-2 h-full relative animate-fade-in">
                    <button
                            ...
                            <Button
                              ...
                              onClick={async () => {
                                ...
                                const submissionData = {
                                  ...
                                  interval_value:
                                    meterTriggerData.interval_value,
                                  interval_unit: meterTriggerData.interval_unit,
                                  start_threshold_value:
                                    meterTriggerData.start_threshold_value,
                                  start_threshold_unit:
                                    meterTriggerData.interval_unit,
                                  lead_time_value:
                                    meterTriggerData.lead_time_value,
                                  lead_time_unit:
                                    meterTriggerData.interval_unit,
                                  next_iteration:
                                    meterTriggerData.next_iteration,
                                ...
                                try {
                                  ...
                                  queryClient.invalidateQueries({
                                    queryKey: [
                                      `/pm-automation/pm-settings?asset=${id}`,
                                    ],
                                  });
                                } catch (error: any) {
                                  toast({
                                    ...
                                    description:
                                      error.message ||
                                      `Failed to ${isEditMode ? "update" : "create"} PM Trigger settings`,
                                    variant: "destructive",
                                  });
                                }
                              }}
