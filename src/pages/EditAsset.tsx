                                 ...
                                 <div className="flex items-start gap-2 h-10">
                                   ...
                                   <div className="flex items-center gap-2 flex-grow">
                                     <input
                                       type="number"
                                       defaultValue="500"
                                       className="w-20 px-2 py-1 text-sm bg-transparent border-0 border-b border-primary focus:outline-none focus:border-b-2 focus:border-primary transition-all duration-200 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                     />
                                     <select className="px-2 py-1 text-sm bg-transparent border-0 border-b border-primary focus:outline-none focus:border-b-2 focus:border-primary transition-all duration-200 appearance-none cursor-pointer">
                                 ...
                                 <div className="flex items-start gap-2 h-10">
                                   ...
                                   <div className="flex items-center gap-2 flex-grow">
                                     <input
                                       type="number"
                                       defaultValue="50"
                                       className="w-16 px-2 py-1 text-sm bg-transparent border-0 border-b border-primary focus:outline-none focus:border-b-2 focus:border-primary transition-all duration-200 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                     />
