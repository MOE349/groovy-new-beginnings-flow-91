                              ...
                              <div className="space-y-0 pb-4 p-4 mb-4 border-2 border-dashed border-primary/30 rounded-xl bg-gradient-to-br from-card/50 to-background/30 shadow-inner backdrop-blur-sm">
                                   ...
                                   <div className="flex items-baseline gap-2">
                                    ...
                                    <div className="flex items-center gap-2 flex-grow">
                                       ...
                                       />
                                       <select className="w-16 px-2 py-1 pb-0 text-sm bg-transparent border-0 border-b border-primary focus:outline-none focus:border-b-2 focus:border-primary transition-all duration-200 appearance-none cursor-pointer">
