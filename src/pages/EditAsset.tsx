              ...
              <div className="relative w-full h-full">
                ...
                >
                  ...
                  <div className="flex w-1/2 h-full flex-shrink-0">
                    ...
                    <div className="w-full md:w-1/2 pl-3">
                      <div className="p-10 space-y-4 h-full relative before:absolute before:left-0 before:top-4 before:bottom-4 before:w-0.5 before:bg-gradient-to-b before:from-primary/60 before:via-primary/80 before:to-primary/60 before:rounded-full before:shadow-md after:absolute after:right-0 after:top-4 after:bottom-4 after:w-0.5 after:bg-gradient-to-b after:from-primary/60 after:via-primary/80 after:to-primary/60 after:rounded-full after:shadow-md shadow-xl shadow-primary/5 bg-gradient-to-br from-background via-card to-background border border-primary/10 rounded-3xl">
                        ...
                        <div className="absolute top-5 left-8 right-8 flex items-center gap-4 py-1 bg-accent/20 border border-accent/30 rounded-md z-10">
                  ...
                  <div className="flex w-1/2 h-full flex-shrink-0">
                    ...
                    {/* PM Parts Container */}
                    <div className="w-full md:w-1/2 pl-3 pr-6">
                      <div className="p-10 space-y-4 h-[474px] relative before:absolute before:left-0 before:top-4 before:bottom-4 before:w-0.5 before:bg-gradient-to-b before:from-primary/60 before:via-primary/80 before:to-primary/60 before:rounded-full before:shadow-md after:absolute after:right-0 after:top-4 after:bottom-4 after:w-0.5 after:bg-gradient-to-b after:from-primary/60 after:via-primary/80 after:to-primary/60 after:rounded-full after:shadow-md shadow-xl shadow-primary/5 bg-gradient-to-br from-background via-card to-background border border-primary/10 rounded-3xl">
                        <div className="flex items-center gap-4 mb-6 py-1 -mx-2 -mt-5 bg-accent/20 border border-accent/30 rounded-md">
