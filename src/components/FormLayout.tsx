...
const FormLayout = ({
  ...
  return (
    <div className="space-y-0">
      {/* Top Bar */}
      <div className="h-10 flex items-center justify-between px-4 py-1 pb-4 bg-secondary border-b border-border">
      ...
      <div className="bg-card rounded-md shadow-sm px-2 py-1 mt-24">
