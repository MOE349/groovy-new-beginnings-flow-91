...
export const AssetFormLayout = ({
  ...
  const title = isEquipment ? "Equipment Information" : "Attachment Information";
  const altText = isEquipment ? "Equipment" : "Attachment";
  ...
  return (
    <div className="space-y-0">
      ...
      {/* Asset Information Card - Compact */}
      <div className="bg-card rounded-md shadow-sm px-2 py-1 mt-4">
        <form onSubmit={handleSubmit} className="h-full">
          ...
          >
            ...
            {isEquipment && (formData?.code || formData?.name) && (
              ...
              <div className="grid grid-cols-3 gap-x-8 gap-y-2">
                ...
                <div className="p-6 space-y-2 relative before:absolute before:left-0 before:top-4 before:bottom-4 before:w-0.5 before:bg-gradient-to-b before:from-primary/60 before:via-primary/80 before:to-primary/60 before:rounded-full before:shadow-md after:absolute after:right-0 after:top-4 after:bottom-4 after:w-0.5 after:bg-gradient-to-b after:from-primary/60 before:via-primary/80 before:to-primary/60 after:rounded-full after:shadow-md shadow-xl shadow-primary/5 bg-gradient-to-br from-background via-card to-background border border-primary/10 rounded-3xl">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-grow">
                      {renderField({ name: "description", type: "textarea", rows: isEquipment ? 4 : 2 })}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-2 h-10">
                    ...
                    <div className="flex-grow">
                      {renderField({ 
                        ...
                        type: "dropdown", 
                        required: true, 
                        endpoint: isEquipment ? "/assets/equipment_category" : "/assets/attachment_category", 
                        queryKey: isEquipment ? ["equipment_category"] : ["attachment_category"], 
                        optionValueKey: "id", 
                        optionLabelKey: "name"
                      })}
                    </div>
